...
consumerRawLogPath = "localhost/raw"
producerRawLogPath = "lioncub/raw"
consumerPath = "localhost/consumer/remap"
producerPath = "lioncub/producer/remap"

test = False

consumerLog = "test.log" if test else "consumer-remap.log"
producerLog = "test.log" if test else "producer-remap.log"
...
# print "delta " + str(deltaMs) + str(producerNtpDelay+consumerNtpDelay)
